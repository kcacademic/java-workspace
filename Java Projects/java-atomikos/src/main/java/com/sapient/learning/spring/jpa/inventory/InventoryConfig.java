...
@Configuration
@EnableJpaRepositories(basePackages = "com.sapient.learning.spring.jpa.inventory", entityManagerFactoryRef = "inventoryEntityManager", transactionManagerRef = "transactionManager")
public class InventoryConfig {
	...
	public EntityManagerFactory inventoryEntityManager() {
		...
		factory.setPackagesToScan("com.sapient.learning.spring.jpa.inventory");
