...
@Configuration
@EnableJpaRepositories(basePackages = "com.sapient.learning.spring.jpa.order", entityManagerFactoryRef = "orderEntityManager", transactionManagerRef = "transactionManager")
public class OrderConfig {
	...
	public EntityManagerFactory orderEntityManager() {
		...
		factory.setPackagesToScan("com.sapient.learning.spring.jpa.order");
