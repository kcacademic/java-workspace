package com.kchandrakant.learning.spring.jpa.order;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.kchandrakant.learning.spring.jpa.order", entityManagerFactoryRef = "orderEntityManager", transactionManagerRef = "transactionManager")
public class OrderConfig {
	...
	public EntityManagerFactory orderEntityManager() {
		...
		factory.setPackagesToScan("com.kchandrakant.learning.spring.jpa.order");
