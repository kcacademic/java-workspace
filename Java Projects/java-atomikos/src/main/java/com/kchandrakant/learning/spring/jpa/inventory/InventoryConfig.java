package com.kchandrakant.learning.spring.jpa.inventory;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.kchandrakant.learning.spring.jpa.inventory", entityManagerFactoryRef = "inventoryEntityManager", transactionManagerRef = "transactionManager")
public class InventoryConfig {
	...
	public EntityManagerFactory inventoryEntityManager() {
		...
		factory.setPackagesToScan("com.kchandrakant.learning.spring.jpa.inventory");
