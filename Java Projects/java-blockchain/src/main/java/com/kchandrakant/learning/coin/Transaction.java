package com.kchandrakant.learning.coin;

import java.security.PrivateKey;
import java.security.PublicKey;
import java.util.ArrayList;

import com.kchandrakant.learning.util.StringUtil;
...
public class Transaction {
	...
	public boolean processTransaction() {
		...
		for (TransactionInput i : inputs) {
			i.UTXO = MyCoin.UTXOs.get(i.transactionOutputId);
		}

		// Checks if transaction is valid:
		if (getInputsValue() < MyCoin.minimumTransaction) {
			System.out.println("Transaction Inputs too small: " + getInputsValue());
			System.out.println("Please enter the amount greater than " + MyCoin.minimumTransaction);
			return false;
		}
