...
import com.sapient.learning.scheduler.MyScheduler;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		String helloWorldCommand = "java -cp java-mesos-0.0.1-SNAPSHOT.jar com.sapient.learning.executor.MyExecutor";
