package com.sapient.learning.gss;
 ...
 * .... 2. client sends a wrap token to the server. 3. server sends a wrap token
 * back to the client.
 *
 ...
 *
 * Example: java -Djava.security.auth.login.config=jaas-krb5.conf \ GssServer
 *
...
public class GssServer {
	...
	static class GssServerAction implements PrivilegedExceptionAction {
		...
		public Object run() throws Exception {
			...
			GSSCredential serverCreds = manager.createCredential(null, GSSCredential.DEFAULT_LIFETIME, krb5Mechanism,
