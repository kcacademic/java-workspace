...
public class SampleServer {
	...
	public static void main(String[] args) throws IOException, GSSException {
		...
		while (true) {
			...
			/*
			 * Now generate a MIC and send it to the client. This is just for illustration
			 * purposes. The integrity of the incoming wrapped message is guaranteed
			 * irrespective of the confidentiality (encryption) that was used.
			 */
