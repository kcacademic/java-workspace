package com.kchandrakant.learning.jgss;
...
public class SampleClient {
	...
	public static void main(String[] args) throws IOException, GSSException {
		...
		/*
		 * This Oid is used to represent the Kerberos version 5 GSS-API mechanism. It is
		 * defined in RFC 1964. We will use this Oid whenever we need to indicate to the
		 * GSS-API that it must use Kerberos for some purpose.
		 */
		...
		/*
		 * Now we will allow the server to decrypt the message, calculate a MIC on the
		 * decrypted message and send it back to us for verification. This is
		 * unnecessary, but done here for illustration.
		 */
